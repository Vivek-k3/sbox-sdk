...
export const PROVIDERS: Provider[] = [
  ...
  },
  {
    ...
    href: "/adapters/northflank",
    id: "northflank",
    name: "Northflank",
    note: "Services platform; pause = scale-to-zero.",
    previewModel: "subdomain",
    subpath: "sbox-sdk/northflank",
  },
  {
    caps: {
      background: u,
    ...
    href: "/adapters/runloop",
    id: "runloop",
    name: "Runloop",
    note: "AI devboxes; suspend + disk snapshots.",
    previewModel: "subdomain",
    subpath: "sbox-sdk/runloop",
  },
  {
    caps: {
      background: u,
    ...
    href: "/adapters/codesandbox",
    id: "codesandbox",
    name: "CodeSandbox",
    note: "microVMs; hibernate/resume in seconds.",
    previewModel: "subdomain",
    subpath: "sbox-sdk/codesandbox",
  },
  {
    caps: {
      background: u,
    ...
    id: "morph",
    name: "Morph",
    note: "Snapshot-first; instant branch / fork.",
    previewModel: "subdomain",
    subpath: "sbox-sdk/morph",
  },
  {
    caps: {
      background: u,
    ...
    href: "/adapters/blaxel",
    id: "blaxel",
    name: "Blaxel",
    note: "Perpetual sandbox; sub-25ms resume.",
    previewModel: "subdomain",
    subpath: "sbox-sdk/blaxel",
  },
  {
    caps: {
      background: u,
    ...
    id: "beam",
    name: "Beam",
    note: "GPU sandboxes; snapshot + fork.",
    previewModel: "subdomain",
    subpath: "sbox-sdk/beam",
  },
  {
    caps: {
      background: u,
    ...
    href: "/adapters/railway",
    id: "railway",
    name: "Railway",
    note: "Isolated Debian VMs; native streaming + fork.",
    previewModel: "none",
    subpath: "sbox-sdk/railway",
  },
];
...
/**
 * Providers whose adapter targets a product still in beta/preview — surfaced as a
 * "Beta" badge next to the adapter's name. Keyed by provider id (the same id as
 * the page's `icon` frontmatter).
 */
export const BETA_PROVIDERS: ReadonlySet<string> = new Set(["railway"]);
