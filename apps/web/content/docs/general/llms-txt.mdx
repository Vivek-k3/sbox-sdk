...
- **In a chat (ChatGPT, Claude):** paste `https://sbox-sdk.dev/llms.txt` and ask the model to read the index, then fetch the pages it needs — or paste `https://sbox-sdk.dev/llms-full.txt` to load everything at once.
- **In an editor agent (Cursor, Copilot):** add `https://sbox-sdk.dev/llms.txt` as a documentation source.
